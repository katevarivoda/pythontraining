...
class Contact:
    def __init__(self, last_name=None, first_name=None, middlename=None, nickname=None, title=None,
                 company=None, address=None, homephone=None, work=None, mobile=None, homepage=None,
